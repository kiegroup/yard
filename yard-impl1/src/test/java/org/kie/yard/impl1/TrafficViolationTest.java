...
public class TrafficViolationTest {
    ...
    public void testExecution() throws Exception {
        String yamlDecision = new String(IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream("/FEEL/traffic-violation.yml"), true));

        final String CONTEXT = "{\"Driver\": {\n" +
                "    \"Points\": 15\n" +
                "},\n" +
                "\"Violation\": {\n" +
                "    \"Type\": \"speed\",\n" +
    ...
    public void testExecutionJQ() throws Exception {
        String yamlDecision = new String(IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream("/jq/traffic-violation.yml"), true));
